...
The website starts with a Navbar having a [logo](https://github.com/swostikpati/Connections-Lab-Fall-22/blob/main/Week%205/5.2/project1_final/assets/txtart_logo.png) (designed by me) which says ART.txt so as to convey the creation of photo with text. The home page of the website was designed to show boldness especially to showcase. The website was made completely in dark mode. Each of the options in the Navbar have an hover effect and navigate to different parts of the website. The center of the website also has two arrows which scroll to the second section of the website on clicking. The second section of the website contains the major part of the application. I had thought of creating this as a  Magic Canvas, having all the options and user-flows in the website to allow the user to  experiement through different functions all in one place. This section initially has a [cover photo](https://github.com/swostikpati/Connections-Lab-Fall-22/blob/main/Week%205/5.2/project1_final/assets/cover_photo.png) which explains the user what they can expect from the website. On clicking the poster the window resizes into the "Command-center" which shows the user all the options available to them. Each of the button has a different user-flow and at the end of each flow, lies the p5 canvas where the user can view the "text-portrait". The next section was meant to give users some interactive examples of "text-portraits" that they can play with. The photos get converted into "text-portraits" on hovering over them. 
...
• Setting up the example "text-portraits" in the explore page were also difficult while trying to be implemented using JavaScript "mouseover" event interaction. So instead, I created some divs, and put the images as backgrounds instead of real image elements. Adding the hover effect in CSS was fairly easy then.
